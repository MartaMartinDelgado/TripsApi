        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            Swal.fire({
                ...
                html:
                    ...
                    '<input id="tripDate" class="swal2-input" placeholder="Trip Date" value=' + trip['tripDate'] + '>' +
                    '<input id="spotsAvailable" class="swal2-input" placeholder="Spots Available" value=' + trip['spotsAvailable'] + '>',
                focusConfirm: false,
                preConfirm: () => {
                    tripEdit();
                }
